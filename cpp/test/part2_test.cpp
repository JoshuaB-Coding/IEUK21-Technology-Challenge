...
TEST(Part2, showAllPlaylist) {
  ...
  EXPECT_THAT(commandOutput[3], HasSubstr("mY_plaYList")); // changed from commandOutput[4] to commandOutput[3]
  EXPECT_THAT(commandOutput[4], HasSubstr("anotHER_playlist")); // changed from commandOutput[3] to commandOutput[4]
  // playlists should be displayed in order they were created which is why I have changed this order
}
